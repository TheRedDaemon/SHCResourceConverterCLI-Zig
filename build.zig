...
pub fn build(b: *std.Build) void {
    ...
    exe_mod.addImport("SHCResourceConverterCLI_Zig_lib", lib_mod);
    ...
    const lib = b.addLibrary(.{
        .linkage = .static,
        .name = "SHCResourceConverterCLI_Zig",
        .root_module = lib_mod,
    });
    ...
    const install_lib_unit_tests = b.addInstallArtifact(lib_unit_tests, .{
        .dest_sub_path = "SHCResourceConverterCLI_Zig-lib-test.exe",
    });
    ...
    const install_exe_unit_tests = b.addInstallArtifact(exe_unit_tests, .{
        .dest_sub_path = "SHCResourceConverterCLI_Zig-exe-test.exe",
    });
